...
export const company = {
  ...
  documents: {
    /** Form GST REG-06 amended 20.01.2026: certificate and annexure A (places of business); annexure B with designated partners is not published (company's decision, 2026-09-26). */
