...
- Бренд: свой стиль на палитре «Сделано в России» (`руководство к брендированию.pdf`),
  знак «Made in Russia» можно использовать как партнёрскую марку; вектор лежит в
  `src/assets/brand/made-in-russia.svg` (вертикальная версия с обложки гайда). Шрифт Montserrat — через
  Fonts API Astro (`astro.config.mjs`), самохостинг на сборке.
